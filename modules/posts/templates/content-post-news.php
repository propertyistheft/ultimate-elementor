...
<div class="uael-post-wrapper <?php echo wp_kses_post( $this->get_masonry_classes() ); ?> <?php echo ( $is_featured && 1 < $query->post_count ) ? 'uael-post-wrapper-featured' : ''; ?> <?php echo wp_kses_post( $this->get_category_name() ); ?>">
	<div class="uael-post__bg-wrap">
		...
		<?php $this->render_featured_image(); ?>
			...
			<div class="uael-post__content-wrap <?php echo wp_kses_post( $this->get_no_image_class() ); ?>">
				<div class="uael-post__terms-wrap">
					<?php $this->render_term_html(); ?>
				</div>
			<?php
			...
			if ( $is_featured && $this->get_instance_value( 'show_excerpt' ) ) {
